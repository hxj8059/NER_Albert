...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
  ...
  with tf.variable_scope("loss"):
    ...
    logits = tf.reshape(logits, [-1, FLAGS.max_seq_length, 31])
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
      ...
      def metric_fn(per_example_loss, label_ids, logits):
        ...
        precision = tf_metrics.precision(label_ids,predictions,31,[2,3,4,5,6,7],average="macro")
        recall = tf_metrics.recall(label_ids,predictions,31,[2,3,4,5,6,7],average="macro")
        f = tf_metrics.f1(label_ids,predictions,31,[2,3,4,5,6,7],average="macro")
        #
        return {
